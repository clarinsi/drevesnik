...
class NodeInterpreter():
    ...
    def set_node_token_into_db_label(self):
        ...
        elif self.node.proplabel == '@CGXPOS' and self.node.token_restriction != '_':
            return [prechar + 'xpos_s_' + self.node.token_restriction]
        elif self.node.proplabel == '@CGSIZE' and self.node.token_restriction != '_':
            return [prechar + 'size_s_' + self.node.token_restriction]
